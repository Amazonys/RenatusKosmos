...
//
///////////////////////////////////////////
Shader "Terra Invicta/Standard Earth Shader" {
Properties {
...
_AmbientLightColor ("Ambient Light Color", Color) = (1,0.95,0.83,1)
_AtmosNear ("Fresnel Blend", Color) = (0.1686275,0.7372549,1,1)
_AtmosFar ("Fresnel Edge", Color) = (0.4557808,0.5187039,0.9850746,1)
_AtmosFalloff ("Fresnel Falloff", Float) = 3
}
SubShader {
 LOD 200
...
"// shader disassembly not supported on DXBC"
 ...
 Pass {
  Name "FORWARD"
  LOD 200
  Tags { "LIGHTMODE" = "FORWARDADD" "QUEUE" = "Geometry-10" "RenderType" = "Opaque" }
...
"// shader disassembly not supported on DXBC"
 ...
 Pass {
  Name "DEFERRED"
  LOD 200
  Tags { "LIGHTMODE" = "DEFERRED" "QUEUE" = "Geometry-10" "RenderType" = "Opaque" }
  GpuProgramID 150534
Program "vp" {
SubProgram "d3d11 " {
"// shader disassembly not supported on DXBC"
