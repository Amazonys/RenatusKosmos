...
Properties {
[Header(TriplanarNormalUVDist)] _NormalMap ("Normal Map", 2D) = "white" { }
...
[Header(TriplanarDoubleUVDist)] _DistortionMap ("Distortion Map", 2D) = "white" { }
...
[Header(Lightning)] _LightingMaskMap ("Lighting Mask Map", 2D) = "white" { }
...
SubShader {
 ...
 Pass {
  Name "FORWARD"
  Tags { "FORCENOSHADOWCASTING" = "true" "IGNOREPROJECTOR" = "true" "LIGHTMODE" = "FORWARDBASE" "QUEUE" = "Geometry+0" "RenderType" = "Opaque" "SHADOWSUPPORT" = "true" }
  GpuProgramID 64965
Program "vp" {
SubProgram "d3d11 " {
...
"// shader disassembly not supported on DXBC"
 ...
 Pass {
  Name "FORWARD"
  Tags { "FORCENOSHADOWCASTING" = "true" "IGNOREPROJECTOR" = "true" "LIGHTMODE" = "FORWARDADD" "QUEUE" = "Geometry+0" "RenderType" = "Opaque" "SHADOWSUPPORT" = "true" }
...
"// shader disassembly not supported on DXBC"
 ...
 Pass {
  Name "ShadowCaster"
  Tags { "FORCENOSHADOWCASTING" = "true" "IGNOREPROJECTOR" = "true" "LIGHTMODE" = "SHADOWCASTER" "QUEUE" = "Geometry+0" "RenderType" = "Opaque" "SHADOWSUPPORT" = "true" }
  GpuProgramID 201194
Program "vp" {
SubProgram "d3d11 " {
