# Renatus Kosmos
TO INSTALL PROPERLY
This mod requires a short amount of manual installation.
...
# Includes Economic Equalization Overhaul by Verdiss (Free License)
(https://github.com/Verdiss/TI-Economic-Equalization-Overhaul, https://steamcommunity.com/sharedfiles/filedetails/?id=2876646709)
...
Because you copied over the files and installed UMM, you do not need to check the "use mods" button. Some, if not all achievements still work. Use the Enable Achievements mod to get full functionality.
If you did not delete the files in "OVERWRITE" after copying them over, do not check the "use mods" button.